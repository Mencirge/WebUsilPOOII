...
<head>
    ...
    <title>Intranet Docente - ${configuracion.nombreInstitucion}</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-nav">
                        ...
                        <div id="collapseCursos" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
                            <div class="sidebar-accordion-body">
                                <c:forEach var="curso" items="${cursos}">
                                    <a href="${pageContext.request.contextPath}/CargarAlumnosServlet?cursoId=${curso.id}" class="sidebar-accordion-link">
                                        <i class="bi bi-pencil-square me-1"></i> ${curso.codigo}
                                    </a>
                                </c:forEach>
                            </div>
                        </div>
                ...
                <a href="#" class="sidebar-link active" id="nav-courses" onclick="activateTab('courses-tab')">
        ...
        <main class="main-content">
            ...
            <div class="tab-content" id="docenteTabContent">
                
                <!-- Tab Mis Cursos (Por Defecto) -->
                <div class="tab-pane fade show active" id="courses-pane" role="tabpanel">
                    
                    <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-2">
                        <div>
                            <h2 class="fw-bold text-dark m-0">Portal del Docente</h2>
                    ...
                    <!-- Cards Grid -->
                    <h4 class="fw-bold mb-4 text-secondary"><i class="bi bi-journals me-2 text-secondary"></i>Asignaturas Asignadas</h4>
                                ...
                                <div class="card h-100 shadow-sm card-custom p-3">
                                    <div class="card-body d-flex flex-column">
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <i class="bi bi-journal-code text-secondary fs-3"></i>
                                            <div>
                ...
                <div class="tab-pane fade" id="profile-pane" role="tabpanel">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-2">
                        <div>
                            ...
                            <p class="text-muted m-0">Gestiona y actualiza tus datos de contacto docente</p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-custom text-center p-4">
                                ...
                                <h5 class="fw-bold text-dark mb-1">${docente.nombreCompleto}</h5>
                                <p class="text-muted small mb-3">${docente.codigoOCorreo}</p>
                                <span class="badge bg-secondary mb-4 px-3 py-1.5 text-uppercase" style="font-size: 0.75rem;">Especialidad: ${docente.rolNombre}</span>
                            ...
                            <div class="card card-custom p-4">
                                ...
                                <form action="${pageContext.request.contextPath}/controller/ActualizarContactoServlet" method="POST">
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" id="correo_personal" name="correo_personal" value="${docente.correoPersonal}" class="form-control" placeholder="ejemplo@correo.com" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="telefono" name="telefono" value="${docente.telefono}" class="form-control" placeholder="Ej: 987654321" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center border-top pt-3">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-primary-custom fw-bold px-4 text-white" style="background-color: var(--primary-color); border-color: var(--primary-color);">
                                            Guardar Cambios
                                        </button>
                                    </div>
    ...
    <script>
        function activateTab(tabId) {
            ...
            document.getElementById('courses-pane').classList.remove('show', 'active');
            ...
            if (tabId === 'courses-tab') {
                ...
                document.getElementById('courses-pane').classList.add('show', 'active');
